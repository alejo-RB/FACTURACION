...
namespace Facturacion.Controllers
{
    public class MetodoPagoesController : Controller
    {
        ...
        public MetodoPagoesController(FacturaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.MetodoPagos != null ? 
                          ...
                          Problem("Entity set 'FacturaContext.MetodoPagos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FacturaContext.MetodoPagos'  is null.");
            }
            var metodoPago = await _context.MetodoPagos.FindAsync(id);
            if (metodoPago != null)
            {
